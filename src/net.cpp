...
static const char *strDNSSeed[][2] = {
    {"Host", "ip 213.205.229.217"},
    {"Perth", "ip 121.215.159.167"},
    {"North Virginia", "ip 54.221.200.186"},
    {"Sydney", "ip 54.252.196.5"},
    {"Sao Paulo", "ip 54.232.197.215"},
};
...
unsigned int pnSeed[] =
{
    0x6D90B6BE, 0xA2F3D282, 0x5F551051, 0xA2F384A8, 0x4E2E1667, 0x3AA9EA32
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Playtoken is probably already running."), addrBind.ToString().c_str());
        else
